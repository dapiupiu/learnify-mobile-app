    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(context, 1, 'Learn', Icons.menu_book, '/modules'),
  ...
  Widget _buildNavItem(BuildContext context, int index, String label, IconData icon, String route) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [Icon(icon, color: selected ? onTertiaryContainer : outlineVariant), if (selected) ...[const SizedBox(width: 8), Text(label, style: GoogleFonts.quicksand(fontWeight: FontWeight.bold, color: onTertiaryContainer))]]),
      ),
    );
  }
}
